...
<div class="container">
    ...
    <h5 class="text-center" style="padding-top: 30px;padding-bottom: 20px;">Redaguoti patalpa</h5>
        ...
        <div class="row d-flex justify-content-center" style="padding-right: 190px">
            <div class="col-md-8" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-left">
                        {{ Form::number('aukstas', $patalpa->aukstas, ['min'=>0,'max'=>16, 'class' => 'form-control', 'placeholder' => 'Aukštas', 'style' => 'width:50%;']) }}<br/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 text-right">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-left">
                        {{ Form::number('pertvaros', $patalpa->pertvaros,  ['min'=>0,'max'=>16, 'class' => 'form-control', 'placeholder' => 'Patalpos dalių skaičius', 'style' => 'width:50%;']) }}<br/>
                    </div>
                </div>
            </div>
        </div>

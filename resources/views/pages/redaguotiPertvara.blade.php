...
<div class="container">
    ...
    <h5 class="text-center" style="padding-top: 20px">Redaguoti pertvara </h5>
    ...
    <div class="row">
        <div class="col-md-6" style="padding-left:0px">
                ...
                <div class="col-md-6 text-left">
                    {{Form::select('patalpos_id', $patalpos, $pertvara->patalpa->id,
                        [
                            ...
                            'style' => 'margin-bottom: 2px; width: 450px',
                            'id' => 'patalpos'
                        ])
                    }}<br/>
                </div>
            ...
            <div class="row" style="padding-right: 150px;">
                ...
                <div class="col-md-6 text-left">
                    {{ Form::date('startdate', $pertvara->startdate, ['class' => 'form-control', 'style' => 'margin-bottom: 2px; width: 230px']) }}<br/>
                </div>
            </div>
            <div class="row" style="padding-right: 150px;">
                <div class="col-md-6 text-right">
                ...
                <div class="col-md-6 text-left">
                    {{ Form::date('enddate', $pertvara->enddate, ['class' => 'form-control', 'style' => 'margin-bottom: 2px; width: 230px']) }}<br/>
                </div>
            </div>
